...
public class MainActivity extends AppCompatActivity {
    ...
    private void showToast()
    {
        ...
        toast.setGravity(Gravity.TOP,5,50);
    ...
    {
        final String[] list_itm ={"message1","message2","message3","message4","message5"};
        AlertDialog.Builder dialog_list = new AlertDialog.Builder(MainActivity.this);
        dialog_list.setTitle("使用List呈現");
        dialog_list.setItems(list_itm, new DialogInterface.OnClickListener()
        {
            @Override
            public void onClick(DialogInterface dialogInterface,int i) {
                Toast.makeText(MainActivity.this, "你選的是" +list_itm[i],Toast.LENGTH_SHORT).show();
            }
        });
        dialog_list.show();
    }
